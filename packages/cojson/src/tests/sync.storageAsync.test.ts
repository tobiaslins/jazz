  ...
  test("large coValue streaming", async () => {
    ...
    expect(
      ...
      [
        ...
        "client -> storage | CONTENT Map header: true new: After: 0 New: 100",
        "client -> server | CONTENT Map header: true new: After: 0 New: 100",
        "server -> client | KNOWN Group sessions: header/5",
        "server -> storage | CONTENT Group header: true new: After: 0 New: 5",
        "server -> client | KNOWN Map sessions: header/100",
        "server -> storage | CONTENT Map header: true new: After: 0 New: 100",
      ]
    `);
    ...
    expect(
      ...
      [
        ...
        "storage -> client | CONTENT Map header: true new: After: 0 New: 100",
