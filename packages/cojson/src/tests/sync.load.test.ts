  ...
  test("coValue with circular deps loading", async () => {
    ...
    expect(
      ...
      [
        ...
        "client -> server | CONTENT Group header: false new: After: 3 New: 1",
        "client -> server | CONTENT ParentGroup header: false new: After: 5 New: 1",
        "client -> server | CONTENT Group header: false new: After: 4 New: 1",
        "client -> server | CONTENT ParentGroup header: false new: After: 6 New: 1",
        "client -> server | CONTENT Group header: false new: After: 5 New: 1",
        "client -> server | CONTENT ParentGroup header: false new: After: 7 New: 1",
        "client -> server | CONTENT Map header: true new: After: 0 New: 1",
        "server -> client | KNOWN Group sessions: header/3",
