...
import { Tabs, TabsList, TabsTrigger } from "@/registry/quint/ui/tabs";
...
export function ComponentPreviewTabs({
  ...
  return (
    ...
    >
      ...
      <div
        data-tab={tab}
        className="data-[tab=code]:border-code relative rounded-lg border md:-mx-1 overflow-hidden"
      >
        <div
          data-slot="preview"
...
bg-[radial-gradient(circle,#9a9a9a50_1px,transparent_1px)] 
bg-[size:20px_20px] "
            />
            {component}
          </div>
