...
You can configure how authentication states work in your app with the [JazzProvider](/docs/project-setup/providers/react). The provider offers several options that impact authentication behavior:
...
For detailed information on all provider options, see [Provider Configuration options](/docs/project-setup/providers/react#additional-options).
...
You can configure Guest Mode access with the `guestMode` prop for [Providers](/docs/project-setup/providers/react).
