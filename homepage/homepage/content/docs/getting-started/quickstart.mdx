...
<ContentByFramework framework="react">  
  ...
  <TabbedCodeGroup id="create-react-app" id="create-react-app" default="pnpm" savedPreferenceKey="package-manager">
...
<TabbedCodeGroup id="jazz-provider" id="jazz-provider" savedPreferenceKey="framework">
