...
This release introduces a cleaner separation between Zod and CoValue schemas, simplifies internal access patterns, and includes a major upgrade to Zod v4.
While most applications won’t require extensive refactors, some breaking changes will require action.

## Zod upgrade

We’ve upgraded our Zod dependency from 3.25.28 to 4.0.5. If your project includes its own version of Zod, make sure to upgrade to v4 as well.
Otherwise, you might end up with duplicate Zod versions.
