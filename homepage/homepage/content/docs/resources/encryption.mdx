export const metadata = { 
  description: "Learn how Jazz encrypts your data to ensure privacy and security."
};

# Encryption

Jazz encrypts all your data by default. Here's how it works and what it means for your applications.

## How encryption works

Jazz uses a two-layer encryption system that keeps your data private while allowing real-time collaboration.
