...
import { FileName, TabbedCodeGroup, TabbedCodeGroupItem, StuckCTA } from "@/components/forMdx";
...
<Alert variant="info" className="mt-4 flex gap-2 items-center">
  If you haven't gone through the [React Quickstart](/docs/getting-started/quickstart), you might find this guide a bit confusing. If you're looking for a quick reference, you might find [this page](/docs/react/project-setup#nextjs-integration) or our [Next.js example app](https://github.com/garden-co/jazz/tree/main/examples/jazz-nextjs) more helpful!
</Alert>
...
The last step is to link to your server-rendered page from your MyFestival component so that you can find it easily!
