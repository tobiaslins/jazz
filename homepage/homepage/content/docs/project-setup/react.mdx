...
Add Jazz to your React application in minutes. This guide covers standard React apps, Next.js, and experimental SSR approaches.
...
- [Pure SSR](#pure-ssr)
- [Hybrid SSR + Client Hydration](#hybrid-ssr--client-hydration)
...
- [Provider Configuration](/docs/project-setup/providers/react) - Complete provider options
- [Authentication](/docs/authentication/overview) - Set up user accounts
- [Sync and Storage](/docs/react/sync-and-storage) - Configure data persistence
- [Schemas](/docs/schemas/overview) - Define your data model
