...
Group extensions are very powerful for cascading permissions and are performant enough for the vast majority of use cases. However, if huge numbers of parent groups need to be loaded as part of the dependency chain, there can be a performance impact. 
