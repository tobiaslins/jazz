...
function Iframe(
  ...
  return (
    <Card className="relative col-span-2 w-full overflow-hidden dark:bg-black lg:col-span-2">
      <iframe
        {...props}
        src={src}
          ...
          <div className="col-span-2 md:col-span-full lg:col-span-2">
            {chatId && shareUrl && (
              <div className="flex h-full flex-col justify-between gap-3 text-center">
                ...
                <div>
                  <div className="flex flex-1 gap-2 overflow-hidden rounded border p-2 leading-none shadow-sm">
                    <input
                      className="flex-1"
                      type="text"
                      value={shareUrl}
