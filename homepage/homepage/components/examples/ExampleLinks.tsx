  ...
  return (
    <>
      <div className="flex gap-2">
        <Button styleType="primary" variant="inverted" size="sm" onClick={() => setIsOpen(true)}>
          Use as template
        </Button>
        <Button href={githubUrl} newTab styleType="primary" variant="inverted" size="sm">
          <span className="md:hidden">Code</span>
          <span className="hidden md:inline">View code</span>
        </Button>

        {demoUrl && (
          <Button href={demoUrl} newTab styleType="primary" variant="inverted" size="sm">
