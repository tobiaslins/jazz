...
Run the following command to create a new Jazz project from one of our starter templates or example apps:
...
Learn more about the [create-jazz-app tool](/docs/tools/create-jazz-app) and all its options.
