...
- Only load the fields you need when [subscribing](/docs/using-covalues/subscription-and-loading)
- Consider breaking large CoMaps into smaller linked CoValues
- Use optional references for large nested structures that aren't always needed
