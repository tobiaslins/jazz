...
export const metadata = { title: "Upgrade to Jazz 0.12.0 for React Native" };

# Upgrade to Jazz 0.12.0 for React Native
...
This guide focuses on upgrading **framework-less React Native** applications. If you're using Expo, please see the [Expo upgrade guide](/docs/react-native-expo/upgrade/0-12-0).
