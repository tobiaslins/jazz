...
- [Account Profile & Migrations](#account-profile--migrations): Fixed bug with custom account profile migrations.
...
- [Member Inheritance Changes](#member-inheritance-changes): Updated behavior for the `members` getter method.
