...
<div>
  The new `Resolved` type enforce valid property paths at compile time and guarantee loaded data matches your resolve configuration, eliminating "undefined" errors from unloaded references.
