...
const SessionLogFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_sessionlog_free(ptr >>> 0, 1),
      );
...
export class SessionLog {
  ...
  tryAdd(transactions_json, new_signature_str, skip_verify) {
    ...
    try {
      ...
      const len1 = WASM_VECTOR_LEN;
      const ret = wasm.sessionlog_tryAdd(
        this.__wbg_ptr,
        ptr0,
        len0,
        ptr1,
  ...
  addNewPrivateTransaction(
    ...
    try {
      ...
      const ret = wasm.sessionlog_addNewPrivateTransaction(
        this.__wbg_ptr,
        ptr0,
        len0,
        ptr1,
  ...
  addNewTrustingTransaction(changes_json, signer_secret, made_at) {
    ...
    try {
      ...
      const len1 = WASM_VECTOR_LEN;
      const ret = wasm.sessionlog_addNewTrustingTransaction(
        this.__wbg_ptr,
        ptr0,
        len0,
        ptr1,
  ...
  /**
   * @param {any} transactions_js
   * @returns {string}
   */
  testExpectedHashAfter(transactions_js) {
    let deferred2_0;
    let deferred2_1;
    try {
      const ret = wasm.sessionlog_testExpectedHashAfter(
        this.__wbg_ptr,
        transactions_js,
      );
      var ptr1 = ret[0];
  ...
  decryptNextTransactionChangesJson(tx_index, key_secret) {
    ...
    try {
      ...
      const len0 = WASM_VECTOR_LEN;
      const ret = wasm.sessionlog_decryptNextTransactionChangesJson(
        this.__wbg_ptr,
        tx_index,
        ptr0,
        len0,
