/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 27408b17f9356f23c8e0ce288f7d0f97)
// Runtime types generated with workerd@1.20251008.0 2025-10-08 nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/index");
    durableNamespaces: "KVStore";
  }
  interface Env {
    JAZZ_WORKER_ACCOUNT: string;
    JAZZ_WORKER_SECRET: string;
    JAZZ_API_KEY: string;
    KVStore: DurableObjectNamespace<import("./src/index").KVStore>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<
        Cloudflare.Env,
        "JAZZ_WORKER_ACCOUNT" | "JAZZ_WORKER_SECRET" | "JAZZ_API_KEY"
      >
    > {}
}
